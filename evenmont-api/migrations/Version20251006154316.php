 ...
 */
final class Version20251006154316 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        , capacity INTEGER UNSIGNED DEFAULT NULL, price NUMERIC(10, 2) DEFAULT NULL, status VARCHAR(20) DEFAULT \'published\' NOT NULL, cover_url VARCHAR(255) DEFAULT NULL, CONSTRAINT FK_3BAE0AA7876C4DDA FOREIGN KEY (organizer_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE payment (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER NOT NULL, event_id INTEGER NOT NULL, mollie_id VARCHAR(40) DEFAULT NULL, transaction_ref VARCHAR(191) DEFAULT NULL, checkout_url VARCHAR(1024) DEFAULT NULL, metadata CLOB DEFAULT NULL --(DC2Type:json)
        , provider VARCHAR(20) NOT NULL, amount NUMERIC(10, 2) NOT NULL, currency VARCHAR(3) NOT NULL, status VARCHAR(20) NOT NULL, created_at DATETIME NOT NULL --(DC2Type:datetime_immutable)
